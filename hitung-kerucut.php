...
<head>
    ...
    <title>Hasil Menghitung Luas Permukaan dan Volume Kerucut</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center min-vh-100">
        <div class="card p-5">
            <div class="card-body">
                <h3 class="card-title text-center">Aplikasi Menghitung Luas Permukaan dan Volume Kerucut</h3>
                <br>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $garis_pelukis = sqrt(pow($jari_jari, 2) + pow($tinggi, 2));
                    ...
                    echo "<p class='result'>Garis Pelukis: " . htmlspecialchars(round($garis_pelukis)) . "</p>";
