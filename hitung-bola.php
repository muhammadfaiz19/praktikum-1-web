...
<head>
    ...
    <title>Hasil Menghitung Luas Permukaan dan Volume Bola</title>
    <!-- Bootstrap CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        body {
            background-color: #181C14; /* Dark Greenish Black */
        }
        .card {
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center min-vh-100">
        <div class="card p-5">
            <div class="card-body">
                <h3 class="card-title text-center">Aplikasi Menghitung Luas Permukaan dan Volume Bola</h3>
                <br>
