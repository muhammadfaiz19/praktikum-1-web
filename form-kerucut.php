...
<head>
    ...
    <title>Hitung Luas Permukaan dan Volume Kerucut</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center min-vh-100">
        <div class="card p-5 m-3">
            <div class="card-body">
                <h3 class="card-title text-center mb-4">Form Menghitung Luas Permukaan dan Volume Kerucut</h3>
                <form action="hitung-kerucut.php" method="POST" name="form-kerucut">
                    <div class="mb-4">
